...
ubuntu-base:
	...
	$(PKGINSTALL) nitrogen picom vlc tmux nmon libsasl2-dev gimp xpad  flameshot rtorrent  volumeicon-alsa luajit usb-creator-gtk rofi gnome-screensaver gnome-power-manager acpi neofetch
